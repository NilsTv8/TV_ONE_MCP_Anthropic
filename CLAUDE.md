...
The **no-DCR** variant accepts any `client_id` (capture-redirect-uri pattern). Use this for Copilot Studio, which does not support Dynamic Client Registration (RFC 7591).
